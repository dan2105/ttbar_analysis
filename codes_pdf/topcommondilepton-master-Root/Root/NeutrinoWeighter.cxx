#include "AFPEventSelector/NeutrinoWeighter.h"
#include <iostream>
#include <ctime>
#include "TObject.h"
#include "TRandom3.h"
...
TString NeutrinoWeighter::randomString(size_t l = 26, std::string charIndex = "abcdefghijklmnopqrstuvwxyz")
{ 
  size_t length = 10;
...
void NeutrinoWeighter::RecalculateEtas(double pos_lep_eta, double neg_lep_eta){
  ...
  NeutrinoWeighter::NeutrinoWeighter( int setting, std::string NWtype=""){
  ...
  if (m_do_crystalball_smearing) {
    ...
    //if(!pt_25_50){
    pt_25_50   = /*new*/ TH1F("pt_25_50"   + randomString(), "pt_25_50",   20, -1, 1);
    pt_50_100  = /*new*/ TH1F("pt_50_100"  + randomString(), "pt_50_100",  20, -1, 1);
    pt_100_200 = /*new*/ TH1F("pt_100_200" + randomString(), "pt_100_200", 20, -1, 1);
    pt_200_inf = /*new*/ TH1F("pt_200_inf" + randomString(), "pt_200_inf", 20, -1, 1);
    //}
...
/*double TopCommonDileptonEventSaver::mt2(TLorentzVector jet_1, TLorentzVector jet_2, TLorentzVector lep_1, TLorentzVector lep_2, double met, int n_points){
